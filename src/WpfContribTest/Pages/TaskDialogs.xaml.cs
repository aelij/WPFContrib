...
public partial class TaskDialogs : Page
{
    ...
    private void ShowTaskDialog_Click(object sender, RoutedEventArgs e)
    {
        TaskDialog taskDialog = new()
        {
            ...
            AllowDialogCancellation = AllowCancellation.IsChecked == true
        };
    ...
    {
        TaskDialogButtonData button = new(0, null, null);
        _buttons.Add(button);
    ...
    private void RemoveButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            _ = _buttons.Remove((TaskDialogButtonData)Buttons.SelectedItem);
        }
    }
    ...
    {
        _ = Radios.Items.Add(new RadioData());
