    ...
    where T : struct
{
    ...
    protected abstract override Freezable CreateInstanceCore(); private static void OnAnimationFunctionChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        AnimationClock animationClock)
    {
        ...
        {
            throw new ArgumentException(SR.LinearAnimationBase_InvalidDefaultValue, nameof(defaultOriginValue));
        }
        if (isTo && !Calculator.IsValidAnimationValue(defaultDestinationValue))
        {
            throw new ArgumentException(SR.LinearAnimationBase_InvalidDefaultValue, nameof(defaultDestinationValue));
        }
        if (IsCumulative)
        {
